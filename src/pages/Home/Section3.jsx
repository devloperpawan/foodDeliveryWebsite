    ...
    <>
        <section className='menu_section'>
            <Container>
                ...
                <h2 className='text-center'>OUR CRAZY BURGERS</h2>
                <p className='para'>
                ...
                <Row>
                    {mockData.map((cardsData,index)=>(
                        <CardData key={index} image={cardsData.image} rating = {cardsData.rating} title = {cardsData.title} paragraph = {cardsData.paragraph} price = {cardsData.price}
                ...
                <Row className='pt-5'>
                    ...
                    <Col className='ads_box ads_img2'>
                    <h4 className='mb-0'>Get Your Free</h4>
                    <h5>CHEESE FRIES</h5>
                    <Link to="/" className='btn btn_red px-4 rounded-0'>
                      Learn More
